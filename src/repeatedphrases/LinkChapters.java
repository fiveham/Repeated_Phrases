...
public class LinkChapters {
	...
	public static void main(String[] args) {
		...
		System.out.println("Starting LinkChapters");
		
		System.out.println("Getting list of pairs of HTML and anchor-data files.");
		...
		System.out.println("Got list of FileDataPairs: "+fileDataPairs.size()+" pairs");
		
		for(FileDataPair pair : fileDataPairs){
			try{
				System.out.println("Adding links to "+pair.toString());
				combineFiles( pair.htmlFile, pair.anchFile, threshold );
			} catch(IllegalStateException e){
				System.out.println("An Exception occured: "+e.getMessage());
				System.out.println("Moving to next chapter.");
			}
		}
	}
