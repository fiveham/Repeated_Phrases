...
/**
 * <p>Represents the folders that play significant roles in 
 * this project: Five folders for entire books of the ASOIAF 
 * series in HTML format; four folders for chapters or 
 * chapter-like bodies of text in html format, and five 
 * folders for text files used in identifying repeated 
 * phrases in the corpus and adding links for those phrases 
 * to the html chapters.</p>
 */
public enum Folder {
	...
	/**
	 * <p>The base of the name of files to be saved in or read from this 
	 * directory.  This is non-null only for those 
	 * directories whose contents pertain to phrases of certain sizes 
	...
	public String filename(int size){
		return folderName + IO.DIR_SEP + namebase + '_' + size + IO.TXT_EXT;
	}
