...
public class AnchorInfo implements Comparable<AnchorInfo>{
	 ...
	 * @return the value of the href attribute for the anchor tag that this object represents, 
	 * which is the name of the html chapter file (except the extension) to which this object's 
	 * represented link leads, followed by a hash ("#") and the value of the id of the anchor in 
	 * the linked file of the quote being linked.
	 */
	 ...
	 * object.</p>
	 * @return  the plaintext equivalent of the opening tag of the anchor represented by this 
	 * object.
	 */
	...
	/**
	 * <p>Returns the plaintext contents of the opening tag of this anchor. This is the same as 
	 * what is returned by {@code openingTag()} except for the angle brackets.</p>
	 * @return the plaintext contents of the opening tag of this anchor. This is the same as what 
	 * is returned by {@code openingTag()} except for the angle brackets
	 */
