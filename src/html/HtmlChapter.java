...
public class HtmlChapter implements Iterable<HTMLEntity>, Cloneable{
    ...
    private boolean hasLiteralAt(String literal, int index){
        for(int i = 0; i < literal.length(); i++){
            ...
            index = adjacentElement(index, HtmlChapter::isCharacter, Direction.NEXT);
        }
        return true;
    }
   ...
   HTMLEntity adjacentElement(
    ...
    /**
     * <p>A utility class that crawls the list of HTMLEntity that underlies this HtmlChapter and
    ...
    private class ParagraphIterator implements Iterator<int[]>{
        ...
        /**
         * <p>This ParagraphIterator's position in the list underlying this HtmlChapter.</p>
         */
        private int position;
        
        /**
         * <p>Constructs a ParagraphIterator that works on {@code HtmlChapter.this.content}.</p>
         */
        private ParagraphIterator(){
            position = BEFORE_BEGINNING;
            modCount = HtmlChapter.this.modCount;
        }
        
        @Override
        /**
         * <p>Returns true if this ParagraphIterator has another paragraph block available in the
         * list underlying this HtmlChapter, false otherwise.</p>
         * @return true if this ParagraphIterator has another paragraph block available in the list
         * underlying this HtmlChapter, false otherwise.
         */
        public boolean hasNext(){
            concurrentModificationCheck();
            return -1 != adjacentElement(position, HtmlChapter::isParagraphishOpen, Direction.NEXT);
        }
        
        @Override
        /**
         * <p>Returns an int array of length 2, containng the inclusive lower bound and exclusive
         * upper bound in this HtmlChapter's underlying list of the opening and closing tags of the
         * next paragraph.</p>
         * @return an int array of length 2, containng the inclusive lower bound and exclusive upper
         * bound in this HtmlChapter's underlying list of the opening and closing tags of the next
         * paragraph.
         */
        public int[] next(){
            concurrentModificationCheck();
            int start = adjacentElement(position, HtmlChapter::isParagraphishOpen, Direction.NEXT);
        ...
        /**
         * <p>Throws a ConcurrentModificationException if the underlying HtmlChapter was modified after
         * this ParagraphIterator was constructed.</p>
         * @throws ConcurrentModificationException if the underlying HtmlChapter was modified after
        ...
        private void concurrentModificationCheck(){
            if(this.modCount != HtmlChapter.this.modCount){
                throw new ConcurrentModificationException(
                        "Mismatch between " 
                        + "ParagraphIterator.this.modCount and HtmlChapter.this.modCount: (" 
                        + this.modCount + " != " + HtmlChapter.this.modCount + ")");
            }
        }
    }
    ...
    /**
     * returns a list of the indices in this HtmlChapter of the opening paragraph tag of an empty 
     * paragraph
     * @return
     */
    ...
    private int backMatterStart(){
        ...
        int pIndex = adjacentElement(textIndex, HtmlChapter::isParagraphishOpen, Direction.NEXT);
    ...
    private static class ApostrophePattern{
        ...
        private boolean match(HtmlChapter h, int index){
        ...
        private static enum Side{
            ...
            boolean match(ApostrophePattern pattern, HtmlChapter h, int a){
            ...
            private int nextInt(int a, HtmlChapter h){
                do{
         ...
         */
        private static Character characterAt(int index, HtmlChapter h){
    ...
    private Collection<HtmlChapter> handleNovel(){
        ...
        HtmlChapter.ParagraphIterator piter = new ParagraphIterator();
     ...
     */
    private static String chapterFileName(HtmlChapter file, int chapterIndex, String chapterName){
     ...
     * @param paragraph a list of HTMLEntity, a piece of an HtmlChapter
    ...
    //TODO make sure that splitChapter implementation methods can't bastardize the HtmlChapter 
    ...
    //multiple times to the same HtmlChapter object
    private Collection<HtmlChapter> handleNovella(){
        HtmlChapter copy = clone();
